    ...
    _createClass(PopUp, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement('div', { className: (0, _classnames2.default)(_index2.default.popUp_mask, theme.popUp_mask), onClick: this.handleMaskClick }),
                _react2.default.createElement(
                    'div',
                    { className: (0, _classnames2.default)(_index2.default.popUp_wrapper, theme.popUp_wrapper) },
                    ...
                    !!title && _react2.default.createElement(
                        'div',
                        { className: (0, _classnames2.default)(_index2.default.popUp_title, theme.popUp_title) },
                        title
                    ),
                    _react2.default.createElement(
                        'section',
                        { className: (0, _classnames2.default)(_index2.default.popUp_content, theme.popUp_content) },
                        content
                    ),
                    !!isShowFooter && _react2.default.createElement(
                        'div',
                        { className: (0, _classnames2.default)(_index2.default.popUp_footer, theme.popUp_footer) },
                        _react2.default.createElement(
                            'button',
                            {
                                className: (0, _classnames2.default)(_index2.default.popUp_footer_left, theme.popUp_footer_left),
                        ...
                        _react2.default.createElement(
                            'button',
                            {
                                className: (0, _classnames2.default)(_index2.default.popUp_footer_right, theme.popUp_footer_right),
